...
{
    return  ( m_year == otherDate.m_year ) &&
...
bool Date::operator < ( const Date &otherDate ) const
{
    ...
    else if( m_year > otherDate.m_year )
    {
        return false;
    }
    if( m_month < otherDate.m_month )
    {
        return true;
    }
    else if( m_month > otherDate.m_month )
    {
        return false;
    }
    return m_day < otherDate.m_day;
}
