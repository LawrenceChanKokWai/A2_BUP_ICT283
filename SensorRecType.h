...
public:
    ...
    *
    * This function compares two SensorRecType objects to determine their relative order
    * based on the date and time attributes. It returns true if the current object is considered
    * "less than" the other object, and false otherwise.
    *
    * @param[in] other The SensorRecType object to compare against.
    *
    ...
    * This function compares two SensorRecType objects to determine their relative order
    * based on the date and time attributes. It returns true if the current object is considered
    * "greater than" the other object, and false otherwise.
    *
    * @param[in] other The SensorRecType object to compare against.
    *
    ...
    * This function compares two SensorRecType objects to determine their relative order
    * based on the date and time attributes. It returns true if the current object is considered
    * "equals to" the other object, and false otherwise.
    *
    * @param[in] other The SensorRecType object to compare against.
    *
    * @return True if the current object is equals to the other object, false otherwise.
    */
    bool operator==(const SensorRecType &other) const;
