...
public:
    ...
    *
    * This operator checks whether two Date objects have the same day, month, and year.
    *
    * @param[in] otherDate The Date object to compare with.
    * @return true if the day, month, and year of both Date objects are equal, false otherwise.
    *
    * @see Date
    */
    ...
    /**
    * @brief Overloaded not equal operator for Date objects.
    *
    * This operator checks whether two Date objects does not have the same day, month, and year.
    *
    * @param[in] otherDate The Date object to compare with.
    * @return true if the day, month, and year of both Date objects are not equal, false otherwise.
    *
    * @see Date
    */
    bool operator != ( const Date &otherDate ) const;
    ...
    /**
    * @brief Overloaded less than operator for Date objects.
    *
    * This operator checks whether this Date object is less than other Date object.
    *
    * @param[in] otherDate The Date object to compare with.
    * @return true if the day, month, and year of this Date is less than other Date objects, false otherwise.
    *
    * @see Date
    */
    bool operator < ( const Date &otherDate ) const;
    ...
    /**
    * @brief Overloaded greater than operator for Date objects.
    *
    * This operator checks whether this Date object is greater than other Date object.
    *
    * @param[in] otherDate The Date object to compare with.
    * @return true if the day, month, and year of this Date is greater than other Date objects, false otherwise.
    *
    * @see Date
    */
    bool operator > ( const Date &otherDate ) const;
